...
// There is no auth in this app, so there is no signed-in user to show.
function TopBar() {
  return (
    <header className="sticky top-0 z-20 flex h-14 items-center gap-4 border-b border-border-strong bg-[rgba(39,34,54,0.72)] px-4 backdrop-blur-glass md:px-7">
      <div className="md:hidden">
        <ProductMark compact />
      </div>
      <div className="hidden md:block">
        <MicroLabel className="text-text-dim">{BRAND.authorName} · internal</MicroLabel>
      </div>
    </header>
  )
}
