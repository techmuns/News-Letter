  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(60% 60% at 60% 45%, var(--illus-glow), transparent 70%)',
          filter: 'blur(8px)',
        }}
      />
      <svg
      ...
      >
        <defs>
          <linearGradient id="ws-folder" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" stopColor="var(--illus-1)" />
            <stop offset="1" stopColor="var(--illus-2)" />
          </linearGradient>
          <linearGradient id="ws-flap" x1="0" y1="0" x2="0.4" y2="1">
            <stop offset="0" stopColor="var(--illus-3)" />
            <stop offset="1" stopColor="var(--illus-4)" />
          </linearGradient>
          <linearGradient id="ws-card" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="var(--illus-card-1)" />
            <stop offset="1" stopColor="var(--illus-card-2)" />
          </linearGradient>
        </defs>
        ...
        <g opacity="0.92" transform="translate(150 26)">
          ...
          <g transform="rotate(-11 60 60)">
            <rect x="18" y="20" width="78" height="98" rx="10" fill="url(#ws-card)" stroke="var(--illus-stroke)" />
            <rect x="30" y="34" width="40" height="26" rx="5" fill="var(--illus-tile)" opacity="0.6" />
            <path d="M32 56l9-8 7 6 6-5 8 9" stroke="var(--illus-3)" strokeWidth="1.6" opacity="0.7" fill="none" />
            <circle cx="60" cy="42" r="3.4" fill="var(--illus-soft)" opacity="0.8" />
            <rect x="30" y="70" width="52" height="4" rx="2" fill="var(--illus-line-1)" />
            <rect x="30" y="80" width="40" height="4" rx="2" fill="var(--illus-line-2)" />
          </g>
          ...
          <g transform="rotate(6 130 40)">
            ...
            <rect x="108" y="46" width="52" height="4" rx="2" fill="var(--illus-line-1)" />
            <rect x="108" y="56" width="44" height="4" rx="2" fill="var(--illus-line-2)" />
            <rect x="108" y="66" width="48" height="4" rx="2" fill="var(--illus-line-2)" />
          </g>

          <g transform="translate(66 -6) rotate(-2)">
            <rect x="60" y="0" width="62" height="60" rx="9" fill="var(--surface)" stroke="var(--illus-stroke)" />
            <text
              x="76"
              y="38"
